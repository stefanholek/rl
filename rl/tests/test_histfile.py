...
class HistoryFileTests(JailSetup):
    ...
    def test_append_file_raises_exception(self):
        self.assertRaises(IOError,
            readline.append_history_file, 0, '~/~/.my_history')
    ...
    def test_append_relative(self):
        ...
        history.append('fred')
        history.append('wilma')
        readline.append_history_file(2, 'my_history')
        history.clear()
        history.read_file('my_history', raise_exc=True)
        self.assertEqual(len(history), 2)
    ...
    def test_append_abspath(self):
        ...
        history.append('fred')
        history.append('wilma')
        readline.append_history_file(2, abspath('my_history'))
        history.clear()
        history.read_file('my_history', raise_exc=True)
        self.assertEqual(len(history), 2)
    ...
    def test_append_default_name(self):
        ...
        history.append('fred')
        history.append('wilma')
        readline.append_history_file(2)
        history.clear()
    ...
    def test_append_None_name(self):
        ...
        history.append('fred')
        history.append('wilma')
        readline.append_history_file(2, None)
        history.clear()
        history.read_file(self.histfile, raise_exc=True)
        self.assertEqual(len(history), 2)
    ...
    def test_append_empty_string(self):
        ...
        history.append('fred')
        history.append('wilma')
        self.assertRaises(IOError, readline.append_history_file, 1, '')
    ...
    def test_append_tilde_expanded(self):
        ...
        history.append('fred')
        history.append('wilma')
        readline.append_history_file(2, '~/.history')
        history.clear()
        history.read_file(self.histfile, raise_exc=True)
        self.assertEqual(len(history), 2)
    ...
    if sys.version_info[0] >= 3:
        ...
        def test_append_bytes_name(self):
            ...
            history.append('fred')
            history.append('wilma')
            readline.append_history_file(2, bytes('my_history', sys.getfilesystemencoding()))
            history.clear()
            history.read_file(bytes('my_history', sys.getfilesystemencoding()), raise_exc=True)
            self.assertEqual(len(history), 2)
